Let $x$ be the interval $[a, b]$\fnote{$[a, b]$ denotes the interval with lower-bound $a$ and upper-bound~$b$.}, and let $y$ be the interval $[c, d]$, for some numbers $a, b, c, d$.  Then $x+y$ is the interval $[a+c, b+d]$, so its width is:
$$
